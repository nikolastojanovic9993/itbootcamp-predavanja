...
let a1 = new Auto("Citroen C4", "crna", false, 4);
// Nakon ovoga, a1 je objekat koji ima sledeca polja:
//a1._marka (vrednost ovog polje je "Citroen C4");
//a1._boja (vrednost ovog polja ej "crna");
...
a4._imakrov = false;// ovo je novi parametar jer ne postoji u klasi sa tim imenom, samo ga prihvata i pici dalje
console.log(a4);
...
a1._brojVrata = 5; // Poljima se pristupa bez zagrada
...
let a5 = new Auto("    AudiA4", "plava", false, 3);
console.log(a5);
